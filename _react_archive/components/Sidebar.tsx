...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const techMenuItems: MenuItem[] = [
    ...
    { id: ViewType.VALIDATION_PROTOCOL, label: t[ViewType.VALIDATION_PROTOCOL], number: 2, category: 'technical' },
    { id: ViewType.DOCUMENTATION, label: t[ViewType.DOCUMENTATION], number: 3, category: 'technical' },
    { id: ViewType.BOM, label: t[ViewType.BOM], number: 4, category: 'technical' },
    { id: ViewType.PROCESS_FLOW, label: t[ViewType.PROCESS_FLOW], number: 5, category: 'technical' },
    { id: ViewType.PFMEA, label: t[ViewType.PFMEA], number: 6, category: 'technical' },
    { id: ViewType.MSA, label: t[ViewType.MSA], number: 7, category: 'technical' },
    { id: ViewType.WORK_INSTRUCTIONS, label: t[ViewType.WORK_INSTRUCTIONS], number: 8, category: 'technical' },
    { id: ViewType.CAPABILITIES, label: t[ViewType.CAPABILITIES], number: 9, category: 'technical' },
    { id: ViewType.CAPACITY, label: t[ViewType.CAPACITY], number: 10, category: 'technical' },
    { id: ViewType.EOLT, label: t[ViewType.EOLT], number: 11, category: 'technical' },
    { id: ViewType.FAILURE_CODES, label: t[ViewType.FAILURE_CODES], number: 12, category: 'technical' },
  ];
            ...
            <div className="absolute top-full left-0 w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 shadow-xl rounded-md z-50 max-h-60 overflow-y-auto mt-1">
              {PROJECTS.map((proj) => (
                <div
                  ...
                  className={`px-3 py-2 cursor-pointer text-sm truncate transition-colors ${currentProject === proj
          ...
          {mainMenuItems.map((item) => (
            <div key={item.id}>
              <button
                ...
                className={`w-full flex items-center space-x-3 px-3 py-2.5 rounded-md mb-1 transition-all duration-200 ${activeView === item.id
              ...
              {item.id === ViewType.STATUS && (
                <button
                  ...
                  className={`w-full flex items-center space-x-3 px-3 py-2 rounded-md mb-1 ml-4 mt-1 transition-colors border-l-2 ${activeView === ViewType.TASK_PRIORITIZATION
          ...
          {techMenuItems.map((item) => (
            <div key={item.id} className="relative group/parent">
              <button
                ...
                className={`w-full flex items-center justify-between space-x-3 px-2 py-2 rounded-md mb-1 transition-colors relative z-10 ${activeView === item.id
              ...
              >
                <div className="flex items-center space-x-3 overflow-hidden">
                  <span className={`flex items-center justify-center w-5 h-5 rounded text-[10px] font-bold transition-colors flex-shrink-0 ${activeView === item.id
                ...
                {(item.id === ViewType.BOM || item.id === ViewType.EQUIPMENT) && (
                  <ChevronRight size={14} className={`transition-transform duration-200 ${(item.id === ViewType.BOM && isBomExpanded) || (item.id === ViewType.EQUIPMENT && isEquipmentExpanded) ? 'rotate-90' : ''
                    }`} />
                )}
              </button>
              ...
              {item.id === ViewType.BOM && isBomExpanded && (
                <div className="relative flex flex-col mb-1 ml-3.5">
                  {/* Tree connector line */}
                  <div className={`absolute left-[5px] -top-3 h-[28px] w-[15px] border-l-2 border-b-2 rounded-bl-lg pointer-events-none transition-colors duration-200 z-0 ${activeView === ViewType.VISUAL_AIDS
                  ...
                  <button
                    ...
                    className={`ml-[22px] flex items-center space-x-2 px-2 py-1.5 rounded-md transition-all relative z-10 w-[calc(100%-24px)] ${activeView === ViewType.VISUAL_AIDS
                  ...
                  >
                    <span className={`flex items-center justify-center min-w-[20px] h-4 rounded text-[9px] font-bold transition-colors flex-shrink-0 ${activeView === ViewType.VISUAL_AIDS
              ...
              {item.id === ViewType.EQUIPMENT && isEquipmentExpanded && (
                <div className="relative flex flex-col mb-1 ml-3.5 space-y-1">
                  ...
                  <div className="relative">
                    <div className={`absolute left-[5px] -top-3 h-[28px] w-[15px] border-l-2 border-b-2 rounded-bl-lg pointer-events-none transition-colors duration-200 z-0 ${activeView === ViewType.EQUIPMENT_IPS
                        ? 'border-preh-petrol dark:border-preh-light-blue'
                        : 'border-gray-200 dark:border-gray-700'
                      }`}></div>
                    <button
                      onClick={() => onNavigate(ViewType.EQUIPMENT_IPS)}
                      className={`ml-[22px] flex items-center space-x-2 px-2 py-1.5 rounded-md transition-all relative z-10 w-[calc(100%-24px)] ${activeView === ViewType.EQUIPMENT_IPS
                          ? 'bg-preh-petrol/10 dark:bg-preh-light-blue/10 text-preh-petrol dark:text-preh-light-blue font-bold shadow-sm'
                          : 'text-gray-500 dark:text-gray-400 hover:text-preh-petrol dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800'
                        }`}
                    >
                      <span className={`flex items-center justify-center min-w-[20px] h-4 rounded text-[9px] font-bold transition-colors flex-shrink-0 ${activeView === ViewType.EQUIPMENT_IPS
                          ? 'bg-preh-petrol text-white dark:bg-preh-light-blue dark:text-gray-900'
                          : 'bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400'
                        }`}>
                        1.1
                  ...
                  <div className="relative">
                    <div className={`absolute left-[5px] -top-[38px] h-[64px] w-[15px] border-l-2 border-b-2 rounded-bl-lg pointer-events-none transition-colors duration-200 z-0 ${activeView === ViewType.EQUIPMENT_PHOTOS
                        ? 'border-preh-petrol dark:border-preh-light-blue'
                        : 'border-gray-200 dark:border-gray-700'
                      }`}></div>
                    <button
                      onClick={() => onNavigate(ViewType.EQUIPMENT_PHOTOS)}
                      className={`ml-[22px] flex items-center space-x-2 px-2 py-1.5 rounded-md transition-all relative z-10 w-[calc(100%-24px)] ${activeView === ViewType.EQUIPMENT_PHOTOS
                          ? 'bg-preh-petrol/10 dark:bg-preh-light-blue/10 text-preh-petrol dark:text-preh-light-blue font-bold shadow-sm'
                          : 'text-gray-500 dark:text-gray-400 hover:text-preh-petrol dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800'
                        }`}
                    >
                      <span className={`flex items-center justify-center min-w-[20px] h-4 rounded text-[9px] font-bold transition-colors flex-shrink-0 ${activeView === ViewType.EQUIPMENT_PHOTOS
                          ? 'bg-preh-petrol text-white dark:bg-preh-light-blue dark:text-gray-900'
                          : 'bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400'
                        }`}>
                        1.2
